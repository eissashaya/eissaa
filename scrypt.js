document.addEventListener('DOMContentLoaded', function() {
    ...
    if (hour >= 18 || hour < 6) {
        ...
        nightModeBtn.querySelector('i').className = 'fas fa-sun';
    }
    ...
    setupModal('.show-details-btn', 'modalOverlay');
    setupModal('[data-work="cars"]', 'modalCars');
    setupModal('[data-work="mobiles"]', 'modalMobiles');
    ...
    // ✅ تجربة النظام
    document.querySelectorAll('.demo-btn, .demo-system').forEach(btn => {
        btn.addEventListener('click', function(e) {
            e.preventDefault();
            alert('تجربة النظام متاحة حالياً فقط عبر التواصل المباشر. يرجى التواصل على الرقم: +');
        });
    });
